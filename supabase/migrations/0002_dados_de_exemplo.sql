-- =====================================================================
-- ECOVILLE NEWS — conteúdo de exemplo (placeholders editáveis pelo painel)
-- ---------------------------------------------------------------------
-- Três edições-modelo, uma por trilha. Todo o conteúdo é fictício: nenhum
-- número, política ou informação institucional real da Ecoville foi usado.
-- O editor pode reescrever ou excluir tudo em /admin.
--
-- Este arquivo é a versão SQL de src/lib/seed-data.ts (o mesmo conteúdo que
-- a área pública mostra quando o Supabase ainda não está conectado).
-- Requer 0001_schema_completo.sql aplicado antes.
-- =====================================================================

insert into public.newsletters
  (slug, titulo, categoria, status, data_publicacao, autor, resumo, tempo_leitura_min, tags, corpo)
values
(
  'exemplo-ficha-tecnica-no-balcao',
  'Exemplo: como usar a ficha técnica de um desengordurante no balcão',
  'produtos', 'publicado', date '2026-08-18', 'Matriz Ecoville',
  'Edição-modelo mostrando como transformar dado técnico de rótulo em argumento de venda durante o atendimento presencial.',
  4,
  array['exemplo', 'ficha técnica', 'argumento de venda', 'treinamento'],
  $html$<p><strong>Conteúdo de exemplo.</strong> Esta edição existe para demonstrar o formato. Substitua pelo material real da rede.</p>
...
<p><em>Placeholder editorial — dados técnicos reais devem vir da área de produtos da matriz.</em></p>$html$
),
(
  'exemplo-vitrine-que-converte-em-7-dias',
  'Exemplo: reorganizando a vitrine para aumentar conversão em 7 dias',
  'impulsionar-a-loja', 'publicado', date '2026-08-11', 'Matriz Ecoville',
  ...
  5,
  array['exemplo', 'vitrine', 'conversão', 'marketing local'],
  $html$<p><strong>Conteúdo de exemplo.</strong> Use como esqueleto de uma edição real da trilha Impulsionar a Loja.</p>
...
<p><em>Placeholder editorial — metas e números reais devem ser definidos pela matriz.</em></p>$html$
),
(
  'exemplo-precificacao-sem-perder-margem',
  'Exemplo: revisando a precificação sem perder margem no atacado',
  'dicas-economicas', 'publicado', date '2026-08-04', 'Matriz Ecoville',
  'Edição-modelo sobre markup, política de desconto e checklist de negociação para pedidos de maior volume.',
  6,
  array['exemplo', 'precificação', 'margem', 'negociação'],
  $html$<p><strong>Conteúdo de exemplo.</strong> Serve de modelo para a trilha Dicas Econômicas.</p>
...
<p><em>Placeholder editorial — pisos de margem reais devem ser definidos pela matriz.</em></p>$html$
)
